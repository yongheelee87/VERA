    ...
    def uiDefinitions(self):
        def dobleClickMaximizeRestore(event):
            ...
            if event.type() == QEvent.MouseButtonDblClick:
                QTimer.singleShot(250, lambda: UIFunctions._maximize_restore(self))
        ...
        if Settings.ENABLE_CUSTOM_TITLE_BAR:
            ...
            def moveWindow(event):
                ...
                if UIFunctions.returStatus(self):
                    UIFunctions._maximize_restore(self)
                # MOVE WINDOW
        ...
        # MAXIMIZE/RESTORE
        self.ui.maximizeRestoreAppBtn.clicked.connect(lambda: UIFunctions._maximize_restore(self))
