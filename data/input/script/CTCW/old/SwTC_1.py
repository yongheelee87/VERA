...
for i, res in zip(intput_data, expected_result):
    ...
    t32.write_symbol('ACSetTemp.phyVal', var1)
    t32.write_symbol('CTCW_Internal_Var.ACSetTemp.phyVal', var2)
    t32.write_symbol('ACSetTemp.isReserved', var3)
    t32.write_symbol('ACSetTemp.isInvaild', var4)

    time.sleep(0.5)

    var5 = t32.read_symbol('CTCW_InterModule_Var.isCCUChange')
